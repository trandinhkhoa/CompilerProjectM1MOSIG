...
public class Main {
	  ...
	  /**
	   * Checks if the input command is correct.
	   * 
	   * @param argv	input command
	   * 
	   * @return True if there is at most 2 non-optional command arguments ; false otherwise.
	   */
	   ...
	   * @param argv	input command
	   * 
	   * @return True if there is at most 2 non-optional command arguments and no missing option argument ; false otherwise.
	   */
