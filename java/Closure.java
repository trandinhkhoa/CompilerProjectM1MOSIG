...
public class Closure implements ObjVisitor<Exp> {
	...
	public Exp visit(Add e) {
		// if ((s.isEmpty())&&(!main_done)) {
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// Add(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(Sub e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// Sub(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(FAdd e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// FAdd(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(FSub e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// FSub(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(FMul e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// FMul(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(FDiv e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// FDiv(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(Eq e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// Eq(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(LE e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// LE(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(If e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// If(e.e1.accept(this),e.e2.accept(this),e.e3.accept(this))));
		// }
	...
	public Exp visit(LetTuple e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// LetTuple(e.ids,e.ts,e.e1.accept(this),e.e2.accept(this))));
		// }if (!s.isEmpty()){
		// Id i = s.peek();
		// List<Id> li= ht.get(i.id);
		// li.addAll(e.ids);
	...
	public Exp visit(Get e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element( new
		// Get(e.e1.accept(this),e.e2.accept(this))));
		// }
	...
	public Exp visit(Put e) {
		...
		// main_done = true;
		// closure_list.add(new Closure_Element(new
		// Put(e.e1.accept(this),e.e2.accept(this),e.e3.accept(this))));
		// }
